...
--- CountDown:time_absolute_seconds()
--- Method
...
--- CountDown:tick()
--- Method
---    Callback executed every second
---
--- Parameters:
---  none
function obj:tick()
...
--- CountDown:startFor(minutes)
--- Method
---    Start the time for the specified time
---
--- Parameters:
---    minutes: number of minutes the timer will run
---
...
---
--- Parameters:
---  * progress - a number specifying the value of progress (0.0 - 1.0)
---
function obj:setProgress(progress)
    ...
    obj:updateTimerString()
    if progress >= 1 then
       -- do nothing... the other callback will finish the timer
    else
       -- advance the timer...
