...
-- Metadata
obj.name = "EvernoteOpenAndTag"
obj.version = "0.1"
obj.author = "Diego Zamboni <diego@zzamboni.org>"
obj.homepage = "https://github.com/Hammerspoon/Spoons"
obj.license = "MIT - https://opensource.org/licenses/MIT"

--- EvernoteOpenAndTag.logger
--- Variable
--- Logger object used within the Spoon. Can be accessed to set the default log level for the messages coming from the Spoon.
obj.logger = hs.logger.new('EvernoteOpenAndTag')

--- EvernoteOpenAndTag:evernoteIsFrontmost()
--- Method
...
--- EvernoteOpenAndTag:tagCurrentNote(tags)
--- Method
...
--- EvernoteOpenAndTag:openAndTagCurrentNote(tags)
--- Method
...
--- EvernoteOpenAndTag:inlineTagCurrentNote(tags)
--- Method
...
--- EvernoteOpenAndTag:bindHotkeys(mapping)
--- Method
